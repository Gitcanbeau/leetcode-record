public class leet980 {
    ...
    public int uniquePathsIII(int[][] grid) {
        //Runtime: 1 ms, faster than 91.91% of Java online submissions for Unique Paths III.
        //Memory Usage: 41.4 MB, less than 61.92% of Java online submissions for Unique Paths III.
    ...
    public int dfs(int grid[][], int x, int y, int zero){
        ...
        if(grid[x][y] == 2){
            return zero == -1 ? 1 : 0; // Why zero = -1, because in above example we have 9 zero's.
        ...
        grid[x][y] = 0; //这是回溯，把之前变成-1的地方再变回来
        zero++;//这是回溯，把之前变成---的地方再++回来
