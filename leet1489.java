...
public class leet1489 {
    ...
    public List<List<Integer>> findCriticalAndPseudoCriticalEdges(int n, int[][] edges) {
        //Runtime: 54 ms, faster than 63.28% of Java online submissions for Find Critical and Pseudo-Critical Edges in Minimum Spanning Tree.
        //Memory Usage: 49.7 MB, less than 43.75% of Java online submissions for Find Critical and Pseudo-Critical Edges in Minimum Spanning Tree.
        ...
        Arrays.sort(edges, (e1, e2)->Integer.compare(e1[2], e2[2])); //按权重排序，
